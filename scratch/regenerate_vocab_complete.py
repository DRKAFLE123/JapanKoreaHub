...
# ─────────────────────────────────────────────────────────────────
# COMPLETE DICTIONARY — ALL 275 VOCAB ITEMS FOR LESSONS 13-20
# ─────────────────────────────────────────────────────────────────
n5_dict = {
    # ── LESSON 13 (39 items) ──
    ...
    "しゅうまつ":           {"kanji": "週末",                "reading": "しゅうまつ",           "nepali": "सप्ताहान्त (हप्ताको अन्त्य)"},
    ...
    "ごろ":                 {"kanji": "頃",                  "reading": "ごろ",                 "nepali": "लगभग / करिब (समयको)"},
    ...
    "さびしい":             {"kanji": "寂しい",              "reading": "さびしい",             "nepali": "एक्लो / एकाकीपन"},
    "かいぎ":               {"kanji": "会議",                "reading": "かいぎ",               "nepali": "बैठक / सभा"},
    "とうろく":             {"kanji": "登録",                "reading": "とうろく",             "nepali": "दर्ता / नाम लेखाउनु"},
    "ていしょく":           {"kanji": "定食",                "reading": "ていしょく",           "nepali": "सेट खाना"},
    "ぎゅうどん":           {"kanji": "牛どん",              "reading": "ぎゅうどん",           "nepali": "गाईको मासु भात (ग्युदोन)"},
    "おまちください。":     {"kanji": "お待ちください。",    "reading": "おまちください",       "nepali": "कृपया पर्खनुहोस्"},
    "そう しましょう":      {"kanji": "そうしましょう",      "reading": "そうしましょう",       "nepali": "त्यसै गरौँ"},
    "べつべつに":           {"kanji": "別々に",              "reading": "べつべつに",           "nepali": "छुट्टाछुट्टा"},
    ...
    "さとん":               {"kanji": "砂糖",                "reading": "さとう",               "nepali": "चिनी"},
    ...
    "まがります":           {"kanji": "曲がります",          "reading": "まがります",           "nepali": "मोड्नु [दायाँ/बायाँ]"},
    "～かた":               {"kanji": "～方",                "reading": "かた",                 "nepali": "गर्ने तरिका / विधि"},
    "いいですよ。":         {"kanji": "いいですよ。",        "reading": "いいですよ",           "nepali": "हुन्छ / ठिक छ"},
    "じゃ":                 {"kanji": "じゃ",                "reading": "じゃ",                 "nepali": "त्यसो भए / त्यसो भयो"},
    "しんごうを みぎへ まがります。": {"kanji": "信号を右へ曲がります。", "reading": "しんごうをみぎへまがります", "nepali": "ट्रफिक लाइटबाट दायाँ मोड्नुहोस्"},
    "これで おねがいします。": {"kanji": "これでお願いします。", "reading": "これでおねがいします", "nepali": "यसैले गरौँ / यसबाट भुक्तान गर्छु"},
    ...
    "しって います":        {"kanji": "知っています",        "reading": "しっています",         "nepali": "थाहा छ / जानेको छु"},
    "すみます":             {"kanji": "住みます",            "reading": "すみます",             "nepali": "बस्नु / निवास गर्नु"},
    "すんで います":        {"kanji": "住んでいます",        "reading": "すんでいます",         "nepali": "बसिरहेको छु / निवास गर्छु"},
    ...
    "じこくひょう":         {"kanji": "時刻表",              "reading": "じこくひょう",         "nepali": "समय तालिका [रेल/बस]"},
    ...
    "こうこう":             {"kanji": "高校",                "reading": "こうこう",             "nepali": "उच्च माध्यमिक विद्यालय"},
    "とこや":               {"kanji": "床屋",                "reading": "とこや",               "nepali": "हजाम / नाउ पसल"},
    "プレイガイド":         {"kanji": "プレイガイド",        "reading": "プレイガイド",         "nepali": "टिकट एजेन्सी (थिएटर)"},
    "どくしん":             {"kanji": "独身",                "reading": "どくしん",             "nepali": "अविवाहित"},
    "独身":                 {"kanji": "独身",                "reading": "どくしん",             "nepali": "अविवाहित"},
    "とくに":               {"kanji": "特に",                "reading": "とくに",               "nepali": "विशेष रूपमा"},
    "ごかぞく":             {"kanji": "ご家族",              "reading": "ごかぞく",             "nepali": "तपाईंको परिवार"},
    ...
    "にゅうがくします":     {"kanji": "入学します",          "reading": "にゅうがくします",     "nepali": "भर्ना हुनु [विश्वविद्यालयमा]"},
    "そつぎょうします":     {"kanji": "卒業します",          "reading": "そつぎょうします",     "nepali": "स्नातक हुनु"},
    ...
    "おてら":               {"kanji": "お寺",                "reading": "おてら",               "nepali": "बौद्ध मन्दिर"},
    "お寺":                 {"kanji": "お寺",                "reading": "おてら",               "nepali": "बौद्ध मन्दिर"},
    "じんじゃ":             {"kanji": "神社",                "reading": "じんじゃ",             "nepali": "शिन्तो मन्दिर"},
    ...
    "あんしょうばんごう":   {"kanji": "暗証番号",            "reading": "あんしょうばんごう",   "nepali": "पिन कोड / गोप्य नम्बर"},
    "暗証番号":             {"kanji": "暗証番号",            "reading": "あんしょうばんごう",   "nepali": "पिन कोड / गोप्य नम्बर"},
    "きんがく":             {"kanji": "金額",                "reading": "きんがく",             "nepali": "रकम / जम्मा"},
    "金額":                 {"kanji": "金額",                "reading": "きんがく",             "nepali": "रकम / जम्मा"},
    "かくにん":             {"kanji": "確認",                "reading": "かくにん",             "nepali": "पुष्टि गर्नु"},
    "確認":                 {"kanji": "確認",                "reading": "かくにん",             "nepali": "पुष्टि गर्नु"},
    "ボタン":               {"kanji": "ボタン",              "reading": "ボタン",               "nepali": "बटन"},
    "～ばん":               {"kanji": "～番",                "reading": "ばん",                 "nepali": "नम्बर ~"},
    "つぎに":               {"kanji": "次に",                "reading": "つぎに",               "nepali": "अर्को पदकम / त्यसपछि"},
    ...
    "もって いきます":      {"kanji": "持って行きます",      "reading": "もっていきます",       "nepali": "साथमा लैजानु"},
    "もっていきます":       {"kanji": "持って行きます",      "reading": "もっていきます",       "nepali": "साथमा लैजानु"},
    "もって きます":        {"kanji": "持って来ます",        "reading": "もってきます",         "nepali": "साथमा ल्याउनु"},
    ...
    "のみます":             {"kanji": "飲みます",            "reading": "のみます",             "nepali": "खानु [औषधि] / पिउनु"},
    "たいせつ":             {"kanji": "大切",                "reading": "たいせつ",             "nepali": "महत्वपूर्ण / कदरयोग्य"},
    "だいじ(な)":           {"kanji": "大事",                "reading": "だいじ",               "nepali": "महत्वपूर्ण / अमूल्य"},
    "だいじょうぶ":         {"kanji": "大丈夫",              "reading": "だいじょうぶ",         "nepali": "ठिकै छ / समस्या छैन"},
    "あぶない":             {"kanji": "危ない",              "reading": "あぶない",             "nepali": "खतरनाक"},
    "きけん(な)":           {"kanji": "危険",                "reading": "きけん",               "nepali": "खतरनाक / जोखिमपूर्ण"},
    "きんえん":             {"kanji": "禁煙",                "reading": "きんえん",             "nepali": "धुम्रपान निषेध"},
    "禁煙":                 {"kanji": "禁煙",                "reading": "きんえん",             "nepali": "धुम्रपान निषेध"},
    "ほけんしょう":         {"kanji": "保険証",              "reading": "ほけんしょう",         "nepali": "स्वास्थ्य बीमा कार्ड"},
    "保険証":               {"kanji": "保険証",              "reading": "ほけんしょう",         "nepali": "स्वास्थ्य बीमा कार्ड"},
    "かぜ":                 {"kanji": "風邪",                "reading": "かぜ",                 "nepali": "रुघा-खोकी / जाडो"},
    "ねつ":                 {"kanji": "熱",                  "reading": "ねつ",                 "nepali": "ज्वरो / बुखार"},
    "熱":                   {"kanji": "熱",                  "reading": "ねつ",                 "nepali": "ज्वरो / बुखार"},
    "びょうき":             {"kanji": "病気",                "reading": "びょうき",             "nepali": "बिरामी / रोग"},
    "病気":                 {"kanji": "病気",                "reading": "びょうき",             "nepali": "बिरामी / रोग"},
    "くすり":               {"kanji": "薬",                  "reading": "くすり",               "nepali": "औषधि"},
    "薬":                   {"kanji": "薬",                  "reading": "くすり",               "nepali": "औषधि"},
    "うわぎ":               {"kanji": "上着",                "reading": "うわぎ",               "nepali": "ज्याकेट / कोट"},
    "上着":                 {"kanji": "上着",                "reading": "うわぎ",               "nepali": "ज्याकेट / कोट"},
    "したぎ":               {"kanji": "下着",                "reading": "したぎ",               "nepali": "भित्री वस्त्र"},
    "下着":                 {"kanji": "下着",                "reading": "したぎ",               "nepali": "भित्री वस्त्र"},
    "すうじつ":             {"kanji": "数日",                "reading": "すうじつ",             "nepali": "केही दिनहरू"},
    "すう～":               {"kanji": "数～",                "reading": "すう～",               "nepali": "केही ~ [गन्ती]"},
    "それで":               {"kanji": "それで",              "reading": "それで",               "nepali": "त्यसैले / त्यही कारण"},
    "どう しましたか。":    {"kanji": "どうしましたか。",    "reading": "どうしましたか",       "nepali": "के भयो? / के समस्या छ?"},
    "[～が] いたいです。":  {"kanji": "[～が]痛いです。",   "reading": "いたいです",           "nepali": "[~मा] दुखेको छ"},
    "おだいじに。":         {"kanji": "お大事に。",          "reading": "おだいじに",           "nepali": "छिट्टै निको हुनुहोस्"},
    ...
    "こうかんします":       {"kanji": "交換します",          "reading": "こうかんします",       "nepali": "साट्नु / विनिमय गर्नु"},
    "うんてんします":       {"kanji": "運転します",          "reading": "うんてんします",       "nepali": "गाडी चलाउनु"},
    "よやくします":         {"kanji": "予約します",          "reading": "よやくします",         "nepali": "आरक्षित गर्नु / बुक गर्नु"},
    "けんがくします":       {"kanji": "見学します",          "reading": "けんがくします",       "nepali": "अध्ययन भ्रमण गर्नु"},
    "ピアノ":               {"kanji": "ピアノ",              "reading": "ピアノ",               "nepali": "पियानो"},
    "メートル":             {"kanji": "メートル",            "reading": "メートル",             "nepali": "मिटर"},
    "こくさい～":           {"kanji": "国際～",              "reading": "こくさい",             "nepali": "अन्तर्राष्ट्रिय ~"},
    "げんきん":             {"kanji": "現金",                "reading": "げんきん",             "nepali": "नगद"},
    "現金":                 {"kanji": "現金",                "reading": "げんきん",             "nepali": "नगद"},
    "しゅみ":               {"kanji": "趣味",                "reading": "しゅみ",               "nepali": "रुचि / हबी"},
    "趣味":                 {"kanji": "趣味",                "reading": "しゅみ",               "nepali": "रुचि / हबी"},
    "にっき":               {"kanji": "日記",                "reading": "にっき",               "nepali": "डायरी"},
    "日記":                 {"kanji": "日記",                "reading": "にっき",               "nepali": "डायरी"},
    "おいのり":             {"kanji": "お祈り",              "reading": "おいのり",             "nepali": "प्रार्थना"},
    "お祈り":               {"kanji": "お祈り",              "reading": "おいのり",             "nepali": "प्रार्थना"},
    "かちょう":             {"kanji": "課長",                "reading": "かちょう",             "nepali": "शाखा प्रमुख"},
    "課長":                 {"kanji": "課長",                "reading": "かちょう",             "nepali": "शाखा प्रमुख"},
    "ぶちょう":             {"kanji": "部長",                "reading": "ぶちょう",             "nepali": "विभाग प्रमुख"},
    "部長":                 {"kanji": "部長",                "reading": "ぶちょう",             "nepali": "विभाग प्रमुख"},
    "しゃちょう":           {"kanji": "社長",                "reading": "しゃちょう",           "nepali": "कम्पनी अध्यक्ष"},
    "社長":                 {"kanji": "社長",                "reading": "しゃちょう",           "nepali": "कम्पनी अध्यक्ष"},
    "どうぶつ":             {"kanji": "動物",                "reading": "どうぶつ",             "nepali": "जनावर"},
    "動物":                 {"kanji": "動物",                "reading": "どうぶつ",             "nepali": "जनावर"},
    "うま":                 {"kanji": "馬",                  "reading": "うま",                 "nepali": "घोडा"},
    "馬":                   {"kanji": "馬",                  "reading": "うま",                 "nepali": "घोडा"},
    "ヘー":                 {"kanji": "ヘー",                "reading": "ヘー",                 "nepali": "अरे! (आश्चर्य)"},
    "おもしろいでしょうね。": {"kanji": "面白いでしょうね。","reading": "おもしろいでしょうね", "nepali": "चाखलाग्दो हुनुपर्छ नि!"},
    "ぼくじょう":           {"kanji": "牧場",                "reading": "ぼくじょう",           "nepali": "फार्म / गोठ"},
    "牧場":                 {"kanji": "牧場",                "reading": "ぼくじょう",           "nepali": "फार्म / गोठ"},
    "そうですか。":         {"kanji": "そうですか。",        "reading": "そうですか",           "nepali": "साँच्चै? / अच्छा"},
    ...
    "おちゃ":               {"kanji": "お茶",                "reading": "おちゃ",               "nepali": "चिया समारोह"},
    "お茶":                 {"kanji": "お茶",                "reading": "おちゃ",               "nepali": "चिया समारोह"},
    "日":                   {"kanji": "日",                  "reading": "ひ",                   "nepali": "दिन / मिति"},
    "調子":                 {"kanji": "調子",                "reading": "ちょうし",             "nepali": "अवस्था / स्थिति"},
    "ちょうしが いい":      {"kanji": "調子がいい",          "reading": "ちょうしがいい",       "nepali": "राम्रो अवस्थामा छ"},
    "ちょうしが わるい":    {"kanji": "調子が悪い",          "reading": "ちょうしがわるい",     "nepali": "नराम्रो अवस्थामा छ"},
    "いちど":               {"kanji": "一度",                "reading": "いちど",               "nepali": "एक पटक"},
    "一度":                 {"kanji": "一度",                "reading": "いちど",               "nepali": "एक पटक"},
    "一度も":               {"kanji": "一度も",              "reading": "いちども",             "nepali": "एक पटक पनि होइन"},
    "なんかいも":           {"kanji": "何回も",              "reading": "なんかいも",           "nepali": "धेरै पटक"},
    "でも":                 {"kanji": "でも",                "reading": "でも",                 "nepali": "तर / तथापि"},
    "どうも。":             {"kanji": "どうも。",            "reading": "どうも",               "nepali": "धन्यवाद। (अनौपचारिक)"},
    ...
    "むり(な)":             {"kanji": "無理",                "reading": "むり",                 "nepali": "असम्भव / बढी"},
    "無理":                 {"kanji": "無理",                "reading": "むり",                 "nepali": "असम्भव / बढी"},
    "ケーキ":               {"kanji": "ケーキ",              "reading": "ケーキ",               "nepali": "केक"},
    ...
    "ぼく":                 {"kanji": "僕",                  "reading": "ぼく",                 "nepali": "म (अनौपचारिक, पुरुषले प्रयोग)"},
    "僕":                   {"kanji": "僕",                  "reading": "ぼく",                 "nepali": "म (अनौपचारिक, पुरुषले प्रयोग)"},
    "きみ":                 {"kanji": "君",                  "reading": "きみ",                 "nepali": "तिमी (साथी/सानालाई)"},
    "君":                   {"kanji": "君",                  "reading": "きみ",                 "nepali": "तिमी (साथी/सानालाई)"},
    "～くん":               {"kanji": "～君",                "reading": "くん",                 "nepali": "जी (अनौपचारिक, साथीलाई)"},
    "ううん":               {"kanji": "ううん",              "reading": "ううん",               "nepali": "उँऊन् (होइन - अनौपचारिक)"},
    ...
    "きもの":               {"kanji": "着物",                "reading": "きもの",               "nepali": "किमोनो (परम्परागत जापानी लुगा)"},
    ...
    "おわり":               {"kanji": "終わり",              "reading": "おわり",               "nepali": "अन्त्य / समाप्त"},
    "終わり":               {"kanji": "終わり",              "reading": "おわり",               "nepali": "अन्त्य / समाप्त"},
    "このあいだ":           {"kanji": "この間",              "reading": "このあいだ",           "nepali": "केही दिन अघि"},
    "ぜんぶで":             {"kanji": "全部で",              "reading": "ぜんぶで",             "nepali": "जम्मा / सबै मिलाएर"},
    "～けど":               {"kanji": "～けど",              "reading": "けど",                 "nepali": "~ तर पनि (अनौपचारिक)"},
    "よかったら":           {"kanji": "よかったら",          "reading": "よかったら",           "nepali": "मन परेमा / सम्भव भएमा"},
    "いろいろ(な)":         {"kanji": "色々",                "reading": "いろいろ",             "nepali": "विभिन्न / अनेक"},
    "みんなで":             {"kanji": "みんなで",            "reading": "みんなで",             "nepali": "सबैजना मिलेर"},
    "こっち":               {"kanji": "こっち",              "reading": "こっち",               "nepali": "यता (अनौपचारिक)"},
    "そっち":               {"kanji": "そっち",              "reading": "そっち",               "nepali": "उता (अनौपचारिक)"},
    "あっち":               {"kanji": "あっち",              "reading": "あっち",               "nepali": "उता पर (अनौपचारिक)"},
...
def get_pos(jp, eng):
    ...
    if any(jp.endswith(v) for v in ['ます', 'する']) or 'verb' in eng_lower:
        return 'Verb'
    elif jp.endswith('い') and not jp.endswith('ない'):
        return 'I-Adj'
    elif jp.endswith('な)') or jp.endswith('(な)'):
        return 'Na-Adj'
    return 'Noun'
...
# ─────────────────────────────────────────────────────────────────
# Write lib/n5-lessons-11to15.ts (keep L11+L12, replace L13-L15)
# ─────────────────────────────────────────────────────────────────
with open("lib/n5-lessons-11to15.ts", "r", encoding="utf-8") as f:
    orig = f.read()

split_pos = orig.find("// LESSON 13")
header = orig[:split_pos].rstrip() if split_pos != -1 else orig.split("export const N5_LESSONS_11TO15")[0] + "export const N5_LESSONS_11TO15: VocabItem[] = [\n"
...
for l in range(13, 21):
    ...
    mapped = [item for item in items if lookup(item["japanese"])]
    total_items += len(items)
    total_mapped += len(mapped)
    print(f"  Lesson {l}: {len(items)} items, {len(mapped)} mapped ✅, {len(items)-len(mapped)} fallback")
pct = total_mapped / total_items * 100
print(f"\n  ✅ TOTAL: {total_mapped}/{total_items} ({pct:.1f}%) items with proper Kanji+Nepali")
