          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm font-black text-white tracking-tight truncate">JapanKoreaHub Knowledge Base</span>
          ...
          <div className="flex-1 bg-slate-900 p-4 sm:p-8 overflow-y-auto space-y-6">
            ...
            <div className="pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-xs text-slate-400 font-mono">
                Verified JapanKoreaHub Knowledge Item • Updated 2026
              </div>
