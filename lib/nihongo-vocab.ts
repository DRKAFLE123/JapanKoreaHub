...
export const NIHONGO_VOCAB_DATA: VocabItem[] = [
  ...
  // ════════════════════════════════════
  // LESSON 27 — Potential Verb Forms 可能動詞
  // ════════════════════════════════════
  { id:'v27_1', lesson:27, level:'N4', word:'話せます', reading:'はなせます', meaning:'Can speak', meaningNepali:'बोल्न सक्नु', kanjiCharacters:['話'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'私は日本語が話せます。', reading:'わたしはにほんごがはなせます。', english:'I can speak Japanese.', nepali:'म जापानी बोल्न सक्छु।'}] },
  { id:'v27_2', lesson:27, level:'N4', word:'読めます', reading:'よめます', meaning:'Can read', meaningNepali:'पढ्न सक्नु', kanjiCharacters:['読'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'かなが読めますか。', reading:'かながよめますか。', english:'Can you read kana?', nepali:'काना पढ्न सक्नुहुन्छ?'}] },
  { id:'v27_3', lesson:27, level:'N4', word:'書けます', reading:'かけます', meaning:'Can write', meaningNepali:'लेख्न सक्नु', kanjiCharacters:['書'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'漢字が書けますか。', reading:'かんじがかけますか。', english:'Can you write Kanji?', nepali:'काञ्जी लेख्न सक्नुहुन्छ?'}] },
  { id:'v27_4', lesson:27, level:'N4', word:'使えます', reading:'つかえます', meaning:'Can use', meaningNepali:'प्रयोग गर्न सक्नु', kanjiCharacters:['使'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'この機械が使えますか。', reading:'このきかいがつかえますか。', english:'Can you use this machine?', nepali:'यो मेसिन चलाउन सक्नुहुन्छ?'}] },
  { id:'v27_5', lesson:27, level:'N4', word:'食べられます', reading:'たべられます', meaning:'Can eat', meaningNepali:'खान सक्नु', kanjiCharacters:['食'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'辛い物が食べられますか。', reading:'からいものがたべられますか。', english:'Can you eat spicy food?', nepali:'पिरो खाना खान सक्नुहुन्छ?'}] },
  { id:'v27_6', lesson:27, level:'N4', word:'起きられます', reading:'おきられます', meaning:'Can get up', meaningNepali:'उठ्न सक्नु', kanjiCharacters:['起'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'毎朝六時に起きられますか。', reading:'まいあさろくじにおきられますか。', english:'Can you get up at 6 every morning?', nepali:'हरेक बिहान ६ बजे उठ्न सक्नुहुन्छ?'}] },
  { id:'v27_7', lesson:27, level:'N4', word:'泳げます', reading:'およげます', meaning:'Can swim', meaningNepali:'पौड्न सक्नु', kanjiCharacters:['泳'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'どのくらい泳げますか。', reading:'どのくらいおよげますか。', english:'How far can you swim?', nepali:'कति टाढासम्म पौड्न सक्नुहुन्छ?'}] },
  { id:'v27_8', lesson:27, level:'N4', word:'運転できます', reading:'うんてんできます', meaning:'Can drive', meaningNepali:'गाडी चलाउन सक्नु', kanjiCharacters:['運','転'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'車の運転ができますか。', reading:'くるまのうんてんができますか。', english:'Can you drive a car?', nepali:'गाडी चलाउन सक्नुहुन्छ?'}] },
  { id:'v27_9', lesson:27, level:'N4', word:'弾けます', reading:'ひけます', meaning:'Can play (instrument)', meaningNepali:'बजाउन सक्नु (साज)', kanjiCharacters:['弾'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'ピアノが弾けますか。', reading:'ピアノがひけますか。', english:'Can you play the piano?', nepali:'पियानो बजाउन सक्नुहुन्छ?'}] },
  { id:'v27_10', lesson:27, level:'N4', word:'見られます', reading:'みられます', meaning:'Can see / Can watch', meaningNepali:'हेर्न सक्नु', kanjiCharacters:['見'], partOfSpeech:'Potential Verb', grammarSentences:[{japanese:'ここから富士山が見られますか。', reading:'ここからふじさんがみられますか。', english:'Can you see Mt. Fuji from here?', nepali:'यहाँबाट फुजि पर्वत देख्न सकिन्छ?'}] },

  // ════════════════════════════════════
  // LESSON 28 — Simultaneous Actions 〜ながら / Multiple Reasons 〜し〜し
  // ════════════════════════════════════
  { id:'v28_1', lesson:28, level:'N4', word:'〜ながら', reading:'〜ながら', meaning:'While doing ~', meaningNepali:'~ गर्दै गर्दा', kanjiCharacters:[], partOfSpeech:'Grammar', grammarSentences:[{japanese:'音楽を聞きながら勉強します。', reading:'おんがくをききながらべんきょうします。', english:'I study while listening to music.', nepali:'सङ्गीत सुन्दै पढ्छु।'}] },
  { id:'v28_2', lesson:28, level:'N4', word:'歩きます', reading:'あるきます', meaning:'To walk', meaningNepali:'हिँड्नु', kanjiCharacters:['歩'], partOfSpeech:'Verb', grammarSentences:[{japanese:'電話を見ながら歩かないでください。', reading:'でんわをみながらあるかないでください。', english:'Please do not walk while looking at your phone.', nepali:'फोन हेर्दै नहिँड्नुस्।'}] },
  { id:'v28_3', lesson:28, level:'N4', word:'〜し、〜し', reading:'〜し、〜し', meaning:'Not only ~, but also ~ (listing reasons)', meaningNepali:'~ पनि, ~ पनि (कारण सूची)', kanjiCharacters:[], partOfSpeech:'Grammar', grammarSentences:[{japanese:'頭が痛いし、熱もあるし、病院へ行きます。', reading:'あたまがいたいし、ねつもあるし、びょういんへいきます。', english:'My head hurts, and I also have a fever, so I will go to the hospital.', nepali:'टाउको दुख्यो, ज्वरो पनि छ, त्यसैले अस्पताल जान्छु।'}] },
  { id:'v28_4', lesson:28, level:'N4', word:'景色', reading:'けしき', meaning:'Scenery / View', meaningNepali:'दृश्य / प्राकृतिक सौन्दर्य', kanjiCharacters:['景','色'], partOfSpeech:'Noun', grammarSentences:[{japanese:'この景色はきれいだし、空気もいいし、好きです。', reading:'このけしきはきれいだし、くうきもいいし、すきです。', english:'The scenery is beautiful, and the air is fresh, so I love it.', nepali:'यो दृश्य राम्रो छ, हावा पनि ताजा छ, मलाई मन पर्छ।'}] },
  { id:'v28_5', lesson:28, level:'N4', word:'料理します', reading:'りょうりします', meaning:'To cook', meaningNepali:'पकाउनु', kanjiCharacters:['料','理'], partOfSpeech:'Verb', grammarSentences:[{japanese:'テレビを見ながら料理します。', reading:'テレビをみながらりょうりします。', english:'I cook while watching TV.', nepali:'टेलिभिजन हेर्दै खाना पकाउँछु।'}] },
  { id:'v28_6', lesson:28, level:'N4', word:'考える', reading:'かんがえる', meaning:'To think / To consider', meaningNepali:'सोच्नु / विचार गर्नु', kanjiCharacters:['考'], partOfSpeech:'Verb', grammarSentences:[{japanese:'よく考えながら答えてください。', reading:'よくかんがえながらこたえてください。', english:'Please think carefully before answering.', nepali:'राम्ररी सोचेर जवाफ दिनुस्।'}] },
  { id:'v28_7', lesson:28, level:'N4', word:'値段', reading:'ねだん', meaning:'Price / Cost', meaningNepali:'मूल्य / दाम', kanjiCharacters:['値','段'], partOfSpeech:'Noun', grammarSentences:[{japanese:'値段も安いし、品質もいいし、このお店がお気に入りです。', reading:'ねだんもやすいし、ひんしつもいいし、このおみせがおきにいりです。', english:'The price is low and the quality is good, so this is my favourite shop.', nepali:'दाम सस्तो छ, गुणस्तर पनि राम्रो छ, यो पसल मलाई मन पर्छ।'}] },

  // ════════════════════════════════════
  // LESSON 29 — Resultant States 〜ています (State Verbs)
  // ════════════════════════════════════
  { id:'v29_1', lesson:29, level:'N4', word:'開いています', reading:'あいています', meaning:'Is open (ongoing state)', meaningNepali:'खुलेको छ (अवस्था)', kanjiCharacters:['開'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'ドアが開いています。', reading:'ドアがあいています。', english:'The door is open.', nepali:'ढोका खुलेको छ।'}] },
  { id:'v29_2', lesson:29, level:'N4', word:'閉まっています', reading:'しまっています', meaning:'Is closed (state)', meaningNepali:'बन्द छ (अवस्था)', kanjiCharacters:['閉'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'スーパーはもう閉まっています。', reading:'スーパーはもうしまっています。', english:'The supermarket is already closed.', nepali:'सुपरमार्केट पहिले नै बन्द भयो।'}] },
  { id:'v29_3', lesson:29, level:'N4', word:'ついています', reading:'ついています', meaning:'Is on (light / machine)', meaningNepali:'बलेको छ / चालु छ', kanjiCharacters:[], partOfSpeech:'Verb State', grammarSentences:[{japanese:'電気がついています。', reading:'でんきがついています。', english:'The light is on.', nepali:'बत्ती बलेको छ।'}] },
  { id:'v29_4', lesson:29, level:'N4', word:'消えています', reading:'きえています', meaning:'Is off / Has disappeared', meaningNepali:'निभेको छ / बन्द छ', kanjiCharacters:['消'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'電気が消えています。', reading:'でんきがきえています。', english:'The light is off.', nepali:'बत्ती निभेको छ।'}] },
  { id:'v29_5', lesson:29, level:'N4', word:'壊れています', reading:'こわれています', meaning:'Is broken (state)', meaningNepali:'बिग्रिएको छ', kanjiCharacters:['壊'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'エアコンが壊れています。', reading:'エアコンがこわれています。', english:'The air conditioner is broken.', nepali:'एयरकन्डिसनर बिग्रिएको छ।'}] },
  { id:'v29_6', lesson:29, level:'N4', word:'並んでいます', reading:'ならんでいます', meaning:'Is lined up (queue)', meaningNepali:'लाइनमा उभिएको छ', kanjiCharacters:['並'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'入口に人が並んでいます。', reading:'いりぐちにひとがならんでいます。', english:'People are standing in line at the entrance.', nepali:'प्रवेशद्वारमा मानिसहरू लाइनमा छन्।'}] },
  { id:'v29_7', lesson:29, level:'N4', word:'結婚しています', reading:'けっこんしています', meaning:'Is married', meaningNepali:'विवाहित हुनु', kanjiCharacters:['結','婚'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'田中さんはもう結婚しています。', reading:'たなかさんはもうけっこんしています。', english:'Mr. Tanaka is already married.', nepali:'तानाका-जी पहिले नै विवाह गरिसक्नुभयो।'}] },
  { id:'v29_8', lesson:29, level:'N4', word:'知っています', reading:'しっています', meaning:'Know (already have knowledge)', meaningNepali:'थाहा छ / जानेको छ', kanjiCharacters:['知'], partOfSpeech:'Verb State', grammarSentences:[{japanese:'田中さんの電話番号を知っていますか。', reading:'たなかさんのでんわばんごうをしっていますか。', english:'Do you know Mr. Tanaka\'s phone number?', nepali:'तानाका-जीको फोन नम्बर थाहा छ?'}] },
