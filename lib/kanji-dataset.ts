...
export const RAW_N5_KANJI: KanjiItem[] = [
  ...
  // ── LESSON 17–20: Communication & Mind ─────────────────────
  ...
  { character: '思', level: 'N5', lessonOrder: 19, strokeCount: 9, readingsOnyomi: ['SHI'], readingsKunyomi: ['omo-u'], meanings: ['Think', 'Feel'], meaningsNepali: ['सोच्नु'], radicals: [{ radical: '心', meaning: 'Heart', color: '#ec4899' }], compounds: [{ word: '思う', reading: 'omou', meaning: 'Think' }, { word: '思い出', reading: 'omoide', meaning: 'Memories' }] },
  { character: '知', level: 'N5', lessonOrder: 20, strokeCount: 8, readingsOnyomi: ['CHI'], readingsKunyomi: ['shi-ru'], meanings: ['Know', 'Notice'], meaningsNepali: ['थाहा हुनु'], radicals: [{ radical: '矢', meaning: 'Arrow', color: '#06b6d4' }], compounds: [{ word: '知る', reading: 'shiru', meaning: 'Know' }, { word: '知人', reading: 'chijin', meaning: 'Acquaintance' }] },
