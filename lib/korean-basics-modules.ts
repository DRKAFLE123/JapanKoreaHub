...
export const KOREAN_BASICS_MODULES: BasicsModule[] = [
  ...
  // ── MODULE 03: PRONUNCIATION & SOUND CHANGES ──
  {
    id: 'module-03',
    moduleNumber: 3,
    title: 'Pronunciation & Sound Changes',
    titleKorean: '한국어 발음 변화 규칙 (Complete Guide)',
    emoji: '🗣️',
    description: 'Master all 10 essential Korean pronunciation rules for beginners: Sound Linking (연음), Nasalization (비음화), Tensification (경음화), Aspiration (격음화/축약), Palatalization (구개음화), Liquidization (유음화), Silent ㅎ, Double Batchim (겹받침), N-addition (ㄴ첨가), and ㄹ Nasalization in Nepali & English.',
    category: 'Pronunciation',
    badgeName: 'Native Pronunciation Master Badge',
    badgeEmoji: '🎙️',
    lessons: [
      {
        id: 'mod3-less1',
        lessonNumber: 1,
        title: 'Rule 1 & 2: Sound Linking (연음) & Silent ㅎ (ㅎ 탈락)',
        titleKorean: '연음 법칙과 ㅎ 탈락/약화 규칙',
        description: 'Learn how bottom consonants (Batchim) slide into silent vowels and how ㅎ becomes silent when followed by vowels.',
        estimatedMinutes: 15,
        contentBlocks: [
          {
            id: 'm3l1_h1',
            type: 'HEADING',
            heading: '1. Sound Linking Rule (연음 법칙 / Lian-eum Beop-chik)',
          },
          {
            id: 'm3l1_t1',
            type: 'TEXT',
            text: 'When a word ends with a Batchim (final consonant) and the following syllable starts with the silent vowel symbol "ㅇ", the Batchim consonant shifts into the "ㅇ" position in spoken Korean. This creates a smooth, continuous flow of speech.',
          },
          {
            id: 'm3l1_tbl1',
            type: 'TABLE',
            tableData: {
              headers: ['Written Form (표기)', 'Spoken Sound (발음)', 'Romanization', 'English Meaning', 'Nepali Meaning (नेपाली अर्थ)', 'Rule Explanation'],
              rows: [
                ['한국어', '[한구거]', 'Han-gu-geo', 'Korean Language', 'कोरियन भाषा', 'ㄱ slides to ㅇ position'],
                ['옷이', '[오시]', 'o-si', 'Clothes (subject)', 'लुगाले / कपडा', 'ㅅ slides to ㅇ position as "s"'],
                ['집에', '[지베]', 'ji-be', 'At home / To house', 'घरमा / घरतिर', 'ㅂ slides to ㅇ position as "b"'],
                ['먹어요', '[머거요]', 'meo-geo-yo', 'Eats / Eating', 'खान्छु / खानुहुन्छ', 'ㄱ slides to ㅇ position'],
                ['꽃이', '[꼬치]', 'kko-chi', 'Flower (subject)', 'फूलले', 'ㅊ slides to ㅇ position as "ch"'],
                ['월요일', '[워료일]', 'wo-ryo-il', 'Monday', 'सोमबार', 'ㄹ slides to initial sound in second syllable'],
              ],
            },
          },
          {
            id: 'm3l1_tip1',
            type: 'TIP',
            heading: 'Quick Formula for Sound Linking',
            text: 'Consonant Batchim + Vowel (ㅇ) = Batchim moves into the Vowel block! Example: [책+이 → 채기] (Chaek-i → Chae-gi / किताबले).',
          },
          {
            id: 'm3l1_h2',
            type: 'HEADING',
            heading: '2. Mute / Muffled ㅎ Rule (ㅎ 탈락 법칙)',
          },
          {
            id: 'm3l1_t2',
            type: 'TEXT',
            text: 'When a Batchim ends with ㅎ (or double batchim ending in ㅎ such as ㄴㅎ or ㄹㅎ) and is followed by a vowel starting with "ㅇ", the ㅎ sound is dropped and becomes completely silent.',
          },
          {
            id: 'm3l1_tbl2',
            type: 'TABLE',
            tableData: {
              headers: ['Written Form', 'Spoken Sound', 'Romanization', 'English', 'Nepali Meaning', 'Sound Change Note'],
              rows: [
                ['좋아요', '[조아요]', 'jo-a-yo', 'Good / Like it', 'राम्रो छ / मन पर्छ', 'ㅎ is silenced completely'],
                ['많아요', '[마나요]', 'ma-na-yo', 'There are many / A lot', 'धेरै छ', 'ㅎ drops, ㄴ links to next vowel'],
                ['싫어요', '[시러요]', 'si-reo-yo', 'Dislike / Don\'t want', 'मन पर्दैन', 'ㅎ drops, ㄹ links to next vowel'],
                ['쌓이다', '[싸이다]', 'ssai-da', 'To be piled up', 'थुप्रिनु / जम्मा हुनु', 'ㅎ is silenced completely'],
                ['넣어요', '[너어요]', 'neo-eo-yo', 'Put in / Insert', 'हाल्छु / राख्छु', 'ㅎ is silenced completely'],
              ],
            },
          },
          {
            id: 'm3l1_ex1',
            type: 'EXAMPLE',
            koreanText: '이 음식이 정말 좋아요! → [이 음식이 정말 조아요!]',
            romanization: 'I eum-sig-i jeong-mal jo-a-yo!',
            translationEn: 'This food is really good! (Note: 음식+이 → 음식이 [음식이], 좋아+요 → 좋아요 [조아요])',
            translationNp: 'यो खाना धेरै राम्रो छ! (उच्चारण: [이 음식이 정말 조아요!])',
          },
        ],
      },
      {
        id: 'mod3-less2',
        lessonNumber: 2,
        title: 'Rule 3: Nasalization (비음화 — Bi-eum-hwa)',
        titleKorean: '비음화 (자음 동화 법칙)',
        description: 'Learn how hard stop consonants (ㄱ, ㄷ, ㅂ) soften into nasal sounds (ㅇ, ㄴ, ㅁ) before ㄴ or ㅁ.',
        estimatedMinutes: 15,
        contentBlocks: [
          {
            id: 'm3l2_h1',
            type: 'HEADING',
            heading: 'Understanding Nasalization (비음화 / Bi-eum-hwa)',
          },
          {
            id: 'm3l2_t1',
            type: 'TEXT',
            text: 'Nasalization happens when hard stop consonants (ㄱ, ㄷ, ㅂ) meet nasal initial consonants (ㄴ, ㅁ). To make speech easier and smoother, your vocal system softens the hard stops into their corresponding nasal consonants: ㄱ becomes [ㅇ], ㄷ becomes [ㄴ], and ㅂ becomes [ㅁ].',
          },
          {
            id: 'm3l2_tbl1',
            type: 'TABLE',
            tableData: {
              headers: ['Rule Category', 'Batchim Group', 'Following Sound', 'Transformed Sound', 'Written Example', 'Spoken Sound', 'Nepali Meaning'],
              rows: [
                ['Rule 3A: ㄱ → [ㅇ]', 'ㄱ, ㅋ, ㄲ', 'ㄴ, ㅁ', '[ㅇ]', '한국말', '[한궁말] (Han-gung-mal)', 'कोरियन भाषा/बोली'],
                ['Rule 3A: ㄱ → [ㅇ]', 'ㄱ, ㅋ, ㄲ', 'ㄴ, ㅁ', '[ㅇ]', '국물', '[궁물] (gung-mul)', 'झोल (Soup / Broth)'],
                ['Rule 3A: ㄱ → [ㅇ]', 'ㄱ, ㅋ, ㄲ', 'ㄴ, ㅁ', '[ㅇ]', '작년', '[장년] (jang-nyeon)', 'पोहोर / गएको वर्ष'],
                ['Rule 3B: ㄷ → [ㄴ]', 'ㄷ, ㅅ, ㅆ, ㅈ, ㅊ, ㅌ', 'ㄴ, ㅁ', '[ㄴ]', '닫는다', '[단는다] (dan-neun-da)', 'बन्द गर्छ (Closes)'],
                ['Rule 3B: ㄷ → [ㄴ]', 'ㄷ, ㅅ, ㅆ, ㅈ, ㅊ, ㅌ', 'ㄴ, ㅁ', '[ㄴ]', '있는', '[이는] → [인는] (in-neun)', 'भएको / रहेको'],
                ['Rule 3B: ㄷ → [ㄴ]', 'ㄷ, ㅅ, ㅆ, ㅈ, ㅊ, ㅌ', 'ㄴ, ㅁ', '[ㄴ]', '맞는', '[만는] (man-neun)', 'मिलने / सही भएको'],
                ['Rule 3C: ㅂ → [ㅁ]', 'ㅂ, ㅍ', 'ㄴ, ㅁ', '[ㅁ]', '입니다', '[임니다] (im-ni-da)', 'हो / हुनुहुन्छ'],
                ['Rule 3C: ㅂ → [ㅁ]', 'ㅂ, ㅍ', 'ㄴ, ㅁ', '[ㅁ]', '십만', '[심만] (sim-man)', '१ लाख (100,000)'],
                ['Rule 3C: ㅂ → [ㅁ]', 'ㅂ, ㅍ', 'ㄴ, ㅁ', '[ㅁ]', '업무', '[엄무] (eom-mu)', 'कार्यालयको काम'],
              ],
            },
          },
          {
            id: 'm3l2_warn1',
            type: 'WARNING',
            heading: 'Crucial for EPS & TOPIK Listening Exam!',
            text: 'In native conversation and audio tests, "입니다" is ALWAYS spoken as [임니다] (im-ni-da) and "한국말" as [한궁말] (han-gung-mal). Recognizing nasalization is essential for Korean listening comprehension!',
          },
          {
            id: 'm3l2_ex1',
            type: 'EXAMPLE',
            koreanText: '저는 한국 사람입니다. → [저는 한국 사람임니다.]',
            romanization: 'Jeo-neun Han-guk sa-ram-im-ni-da.',
            translationEn: 'I am a Korean person. (Note: 입니다 is pronounced [임니다])',
            translationNp: 'म कोरियन मानिस हो। (उच्चारण: [임니다])',
          },
        ],
      },
      {
        id: 'mod3-less3',
        lessonNumber: 3,
        title: 'Rule 4 & 5: Aspiration (격음화) & Tensification (경음화)',
        titleKorean: '격음화(축약)와 경음화(된소리빼기) 규칙',
        description: 'Master how consonants combine with ㅎ into aspirated sounds (ㅋ, ㅌ, ㅍ, ㅊ) and how plain sounds harden after stops.',
        estimatedMinutes: 15,
        contentBlocks: [
          {
            id: 'm3l3_h1',
            type: 'HEADING',
            heading: '1. Aspiration Rule (격음화 / Gyeok-eum-hwa — Heavy Air Sound)',
          },
          {
            id: 'm3l3_t1',
            type: 'TEXT',
            text: 'When plain consonants (ㄱ, ㄷ, ㅂ, ㅈ) combine with "ㅎ" (either before or after), they merge together to create strong aspirated consonants: [ㅋ, ㅌ, ㅍ, ㅊ]. Strong air bursts out when speaking these.',
          },
          {
            id: 'm3l3_tbl1',
            type: 'TABLE',
            tableData: {
              headers: ['Consonant Combination', 'Resulting Sound', 'Written Form', 'Spoken Sound', 'English Meaning', 'Nepali Meaning (네पाली)'],
              rows: [
                ['ㄱ + ㅎ  or  ㅎ + ㄱ', '[ㅋ] (k-aspirated)', '축하', '[추카] (chu-ka)', 'Congratulations', 'बधाई'],
                ['ㄱ + ㅎ  or  ㅎ + ㄱ', '[ㅋ] (k-aspirated)', '좋고', '[조코] (jo-ko)', 'Good and...', 'राम्रो र...'],
                ['ㄷ + ㅎ  or  ㅎ + ㄷ', '[ㅌ] (t-aspirated)', '못해요', '[모태요] (mo-tae-yo)', 'Cannot do', 'गर्न सक्दिन'],
                ['ㄷ + ㅎ  or  ㅎ + ㄷ', '[ㅌ] (t-aspirated)', '따뜻하다', '[따뜨타다] (tta-tteu-ta-da)', 'Warm (weather/food)', 'न्यानो हुनु'],
                ['ㅂ + ㅎ  or  ㅎ + ㅂ', '[ㅍ] (p-aspirated)', '입학', '[이팍] (i-pak)', 'School admission / Entry', 'स्कूल भर्ना / प्रवेश'],
                ['ㅂ + ㅎ  or  ㅎ + ㅂ', '[ㅍ] (p-aspirated)', '잡히다', '[자피다] (ja-pi-da)', 'To be caught', 'समातिनु'],
                ['ㅈ + ㅎ  or  ㅎ + ㅈ', '[ㅊ] (ch-aspirated)', '맞히다', '[마치다] (ma-chi-da)', 'To guess correctly / Answer', 'सही उत्तर मिलाउनु'],
                ['ㅈ + ㅎ  or  ㅎ + ㅈ', '[ㅊ] (ch-aspirated)', '좋지', '[조치] (jo-chi)', 'Isn\'t it good?', 'राम्रो छ नि, हैन?'],
              ],
            },
          },
          {
            id: 'm3l3_h2',
            type: 'HEADING',
            heading: '2. Tensification Rule (경음화 / Gyeong-eum-hwa — Double Sound Hardening)',
          },
          {
            id: 'm3l3_t2',
            type: 'TEXT',
            text: 'When a word has a stop Batchim (ㄱ, ㄷ, ㅂ or their representative sounds) followed by a plain consonant (ㄱ, ㄷ, ㅂ, ㅅ, ㅈ), the second consonant hardens into its double tense form: [ㄲ, ㄸ, ㅃ, ㅆ, ㅉ].',
          },
          {
            id: 'm3l3_tbl2',
            type: 'TABLE',
            tableData: {
              headers: ['Written Form', 'Spoken Sound', 'Romanization', 'English Meaning', 'Nepali Meaning (네पाली)', 'Hardened Consonant'],
              rows: [
                ['학교', '[학꾜]', 'hak-kkyo', 'School', 'विद्यालय / स्कूल', 'ㄱ + ㄱ → [ㄲ]'],
                ['식당', '[식땅]', 'sik-ttang', 'Restaurant', 'रेस्टुरेन्ट / भोजनालय', 'ㄱ + ㄷ → [ㄸ]'],
                ['국밥', '[국빱]', 'guk-ppap', 'Soup rice', 'भात र झोल', 'ㄱ + ㅂ → [ㅃ]'],
                ['잡지', '[잡찌]', 'jap-jji', 'Magazine', 'पत्रिका', 'ㅂ + ㅈ → [ㅉ]'],
                ['옆집', '[엽찝]', 'yeop-jjip', 'Next door house', 'छि메की घर', 'ㅍ(ㅂ) + ㅈ → [ㅉ]'],
                ['있자', '[잇짜]', 'it-jja', 'Let\'s stay', 'बसौँ / रहौँ', 'ㅆ(ㄷ) + ㅈ → [ㅉ]'],
              ],
            },
          },
          {
            id: 'm3l3_ex1',
            type: 'EXAMPLE',
            koreanText: '생일을 축하해요! 식당에서 만나요. → [생इ르추카해요! 식땅에서 만나요.]',
            romanization: 'Saeng-il-eul chu-ka-hae-yo! Sik-ttang-e-seo man-na-yo.',
            translationEn: 'Happy Birthday! Let\'s meet at the restaurant. (축하→[추카], 식당→[식땅])',
            translationNp: 'जन्मदिनको शुभकामना! रेस्टुरेन्टमा भेटौँ। (उच्चारण: [추카], [식땅])',
          },
        ],
      },
      {
        id: 'mod3-less4',
        lessonNumber: 4,
        title: 'Rule 6 & 7: Palatalization (구개음화) & Liquidization (유음화)',
        titleKorean: '구개음화와 유음화 (ㄹ-ㄹ 법칙)',
        description: 'Learn how ㄷ/ㅌ turn into ㅈ/ㅊ before "ㅣ" and how ㄴ and ㄹ assimilate into double [ㄹ-ㄹ] liquid sounds.',
        estimatedMinutes: 15,
        contentBlocks: [
          {
            id: 'm3l4_h1',
            type: 'HEADING',
            heading: '1. Palatalization Rule (구개음화 / Gu-gae-eum-hwa)',
          },
          {
            id: 'm3l4_t1',
            type: 'TEXT',
            text: 'When a word ends with Batchim "ㄷ" or "ㅌ" and is followed by a suffix starting with the vowel "ㅣ" (or "히"), the sound shifts to the palate. ㄷ becomes [ㅈ] (j) and ㅌ becomes [ㅊ] (ch).',
          },
          {
            id: 'm3l4_tbl1',
            type: 'TABLE',
            tableData: {
              headers: ['Written Form', 'Spoken Sound', 'Romanization', 'English Meaning', 'Nepali Meaning (네पाली)', 'Palatal Shift Note'],
              rows: [
                ['같이', '[가치]', 'ga-chi', 'Together', 'सँगै / एकसाथ', 'ㅌ + 이 → [치]'],
                ['해돋이', '[해도지]', 'hae-do-ji', 'Sunrise', 'सूर्योदय / घाम झुल्केको', 'ㄷ + 이 → [지]'],
                ['붙이다', '[부치다]', 'bu-chi-da', 'To stick / To paste', 'टाँस्नु / टाँस्न दिनु', 'ㅌ + 이 → [치]'],
                ['굳이', '[구지]', 'gu-ji', 'Obstinately / Intentionally', 'जबर्दस्ती / खासगरी', 'ㄷ + 이 → [지]'],
                ['닫히다', '[다치다]', 'da-chi-da', 'To be closed', 'बन्द हुनु', 'ㄷ + 히 → [치]'],
              ],
            },
          },
          {
            id: 'm3l4_h2',
            type: 'HEADING',
            heading: '2. Liquidization / Lateralization Rule (유음화 / Yu-eum-hwa — The ㄹ-ㄹ Rule)',
          },
          {
            id: 'm3l4_t2',
            type: 'TEXT',
            text: 'Whenever the consonants "ㄴ" and "ㄹ" meet adjacent to each other (either ㄴ + ㄹ or ㄹ + ㄴ), the "ㄴ" assimilates into "ㄹ", resulting in a double liquid "L" sound: [ㄹ-ㄹ].',
          },
          {
            id: 'm3l4_tbl2',
            type: 'TABLE',
            tableData: {
              headers: ['Combination Type', 'Written Form', 'Spoken Sound', 'Romanization', 'English Meaning', 'Nepali Meaning (네पाली)'],
              rows: [
                ['ㄴ + ㄹ → [ㄹ-ㄹ]', '신라', '[실라]', 'Sil-la', 'Silla Dynasty', 'सिल्ला राज्य (प्राचीन कोरिया)'],
                ['ㄴ + ㄹ → [ㄹ-ㄹ]', '난로', '[날로]', 'nal-ro', 'Heater', 'हीटर / आगो ताप्ने मेसिन'],
                ['ㄴ + ㄹ → [ㄹ-ㄹ]', '연락', '[열락]', 'yeol-rak', 'Contact / Communication', 'सम्पर्क / फोन-मैसेज'],
                ['ㄴ + ㄹ → [ㄹ-ㄹ]', '편리', '[펴ल्ली]', 'pyeol-li', 'Convenient / Handy', 'सुविधाजनक / सजिलो'],
                ['ㄹ + ㄴ → [ㄹ-ㄹ]', '칼날', '[칼날]', 'kal-nal', 'Blade of knife', 'चक्कुको धार'],
                ['ㄹ + ㄴ → [ㄹ-ㄹ]', '설날', '[설날]', 'seol-lal', 'Korean New Year', 'कोरियन नयाँ वर्ष (सल्나ल)'],
              ],
            },
          },
          {
            id: 'm3l4_ex1',
            type: 'EXAMPLE',
            koreanText: '친구와 같이 설날에 연락해요. → [친구와 가치 설날에 열락해요.]',
            romanization: 'Chin-gu-wa ga-chi Seol-lal-e yeol-lak-hae-yo.',
            translationEn: 'I contact my friend together on Korean New Year. (같이→[가치], 설날→[설날], 연락→[열락])',
            translationNp: 'साथीसँगै नयाँ वर्ष (सल्नाल) मा सम्पर्क गर्छु। (उच्चारण: [가치], [설날], [열락])',
          },
        ],
      },
      {
        id: 'mod3-less5',
        lessonNumber: 5,
        title: 'Rule 8, 9 & 10: Double Batchim, N-Addition & ㄹ Nasalization',
        titleKorean: '겹받침, ㄴ 첨가 및 ㄹ의 비음화',
        description: 'Master double batchim pronunciation rules, N-addition in compound words, and ㄹ transforming to ㄴ.',
        estimatedMinutes: 20,
        contentBlocks: [
          {
            id: 'm3l5_h1',
            type: 'HEADING',
            heading: '1. Double Batchim Rules (겹받침 규칙 / Gyeop-batchim Rules)',
          },
          {
            id: 'm3l5_t1',
            type: 'TEXT',
            text: 'Korean has 11 double batchim combinations (겹받침). When spoken before a consonant, only one consonant is pronounced according to strict phonetic rules.',
          },
          {
            id: 'm3l5_tbl1',
            type: 'TABLE',
            tableData: {
              headers: ['Group Rule', 'Double Consonants', 'Pronounced Sound', 'Written Word', 'Spoken Sound', 'Nepali Meaning'],
              rows: [
                ['Front Sound Pronounced (앞 자음)', 'ㄴㅈ, ㄴㅎ, ㄹㅂ, ㄹㅅ, ㄹㅌ, ㄹㅎ, ㅂㅅ', 'First consonant', '앉다', '[안따] (an-tta)', 'बस्नु (To sit)'],
                ['Front Sound Pronounced (앞 자음)', 'ㄴㅈ, ㄴㅎ, ㄹㅂ, ㄹㅅ, ㄹㅌ, ㄹㅎ, ㅂㅅ', 'First consonant', '값', '[갑] (gap)', 'मूल्य (Price)'],
                ['Front Sound Pronounced (앞 자음)', 'ㄴㅈ, ㄴㅎ, ㄹㅂ, ㄹㅅ, ㄹㅌ, ㄹㅎ, ㅂㅅ', 'First consonant', '여덟', '[여덜] (yeo-deol)', 'आठ (Eight)'],
                ['Rear Sound Pronounced (뒤 자음)', 'ㄹㄱ, ㄹㅁ, ㄹㅍ', 'Second consonant', '읽다', '[익따] (ik-tta)', 'पढ्नु (To read)'],
                ['Rear Sound Pronounced (뒤 자음)', 'ㄹㄱ, ㄹㅁ, ㄹㅍ', 'Second consonant', '삶', '[삼] (sam)', 'जीवन (Life)'],
                ['Rear Sound Pronounced (뒤 자음)', 'ㄹㄱ, ㄹㅁ, ㄹㅍ', 'Second consonant', '읊다', '[읍따] (eup-tta)', 'कविता वाचन गर्नु'],
                ['Vowel Follows (모음 연결)', 'All 11 combinations', 'Consonants split!', '읽어요', '[일거요] (il-geo-yo)', 'पढ्छु (Reads)'],
                ['Vowel Follows (모음 연결)', 'All 11 combinations', 'Consonants split!', '값이', '[갑시] (gap-si)', 'मूल्यले (Price subject)'],
              ],
            },
          },
          {
            id: 'm3l5_h2',
            type: 'HEADING',
            heading: '2. N-Addition Rule (ㄴ 첨가 법칙)',
          },
          {
            id: 'm3l5_t2',
            type: 'TEXT',
            text: 'In compound or complex words, when the first root ends in a consonant and the second root begins with ㅣ, 야, 여, 요, 유, an extra [ㄴ] sound is inserted at the boundary, turning them into [니, 냐, 녀, 뇨, 뉴].',
          },
          {
            id: 'm3l5_tbl2',
            type: 'TABLE',
            tableData: {
              headers: ['Compound Word', 'Spoken Sound', 'Romanization', 'English Meaning', 'Nepali Meaning (네पाली)', 'N-Addition Process'],
              rows: [
                ['맨입', '[맨닙]', 'maen-nip', 'Empty mouth / Bare mouth', 'खाली मुख', '맨 + 입 → [맨닙]'],
                ['솜이불', '[솜니불]', 'som-ni-bul', 'Cotton blanket / Quilt', 'कपासको डसना / सिर크', '솜 + 이불 → [솜니불]'],
                ['색연필', '[생년필]', 'saeng-nyeon-pil', 'Colored pencil', 'रंगीन पेन्सिल', '색+연필 → [색년필] → [생년필] (N-addition + Nasalization!)'],
                ['서울역', '[서울녁]→[서울력]', 'se-ul-ryeok', 'Seoul Station', 'सियोल स्टेसन', '서울+역 → [서울녁] → [서울력] (N-addition + Liquidization!)'],
              ],
            },
          },
          {
            id: 'm3l5_h3',
            type: 'HEADING',
            heading: '3. Nasalization of ㄹ (ㄹ의 비음화)',
          },
          {
            id: 'm3l5_t3',
            type: 'TEXT',
            text: 'When "ㄹ" comes after consonants ㄱ, ㄷ, ㅂ, ㅁ, ㅇ as an initial sound in the next syllable: (1) After ㅁ or ㅇ, ㄹ becomes [ㄴ]. (2) After ㄱ or ㅂ, ㄱ/ㅂ first nasalize into [ㅇ/ㅁ], and ㄹ becomes [ㄴ]!',
          },
          {
            id: 'm3l5_tbl3',
            type: 'TABLE',
            tableData: {
              headers: ['Written Form', 'Intermediate Step', 'Final Spoken Sound', 'Romanization', 'English Meaning', 'Nepali Meaning'],
              rows: [
                ['종로', '종 + 로', '[종노]', 'Jong-no', 'Jongno district', 'जोङनो क्षेत्र (सियोल)'],
                ['음료수', '음 + 료수', '[음뇨수]', 'eum-nyo-su', 'Beverage / Soft drink', 'चिसो पेय पदार्थ / ड्रिंक'],
                ['백로', '백 + 로 → 백노', '[뱅노]', 'baeng-no', 'White egret bird', 'बकुल्ला पक्षी'],
                ['압력', '압 + 력 → 압녁', '[암녁]', 'am-nyeok', 'Pressure', 'दबाव / प्रेसर'],
              ],
            },
          },
        ],
      },
      {
        id: 'mod3-less6',
        lessonNumber: 6,
        title: 'Master Summary Table & Pronunciation Practice Quiz',
        titleKorean: '한국어 발음 10대 법칙 총정리 및 퀴즈',
        description: 'Complete reference cheat sheet for all 10 pronunciation rules with interactive quiz practice.',
        estimatedMinutes: 15,
        contentBlocks: [
          {
            id: 'm3l6_h1',
            type: 'HEADING',
            heading: 'Ultimate 10 Pronunciation Rules Cheat Sheet (발음 10대 법칙 요약표)',
          },
          {
            id: 'm3l6_tbl1',
            type: 'TABLE',
            tableData: {
              headers: ['Rule Name (법칙명)', 'Core Formula (핵심 공식)', 'Written Example (표기)', 'Spoken Sound (발음)', 'Nepali Explanation (नेपाली व्याख्या)'],
              rows: [
                ['1. Sound Linking (연음)', 'Batchim + Vowel (ㅇ)', '한국어 / 옷이', '[한구거] / [오시]', 'अन्तिम व्यञ्जन "ㅇ" मा सरेर उच्चारण हुन्छ'],
                ['2. Silent ㅎ (ㅎ탈락)', 'ㅎ + Vowel (ㅇ)', '좋아요 / 많아요', '[조아요] / [마나요]', 'स्वरवर्ण भेट्दा "ㅎ" ध्वनि हराउँछ'],
                ['3. Nasalization (비음화)', 'ㄱ,ㄷ,ㅂ + ㄴ,ㅁ', '한국말 / 입니다', '[한궁말] / [임니다]', 'ㄱ→[ㅇ], ㄷ→[ㄴ], ㅂ→[ㅁ] मा परिणत हुन्छ'],
                ['4. Aspiration (격음화)', 'ㄱ,ㄷ,ㅂ,ㅈ + ㅎ', '축하 / 못해요', '[추카] / [모태요]', 'हावा फालेर ㅋ,ㅌ,ㅍ,ㅊ ध्वनि बन्छ'],
                ['5. Tensification (경음화)', 'ㄱ,ㄷ,ㅂ + ㄱ,ㄷ,ㅂ,ㅅ,ㅈ', '학교 / 식당', '[학꾜] / [식땅]', 'कडा क,त्त,प्प,स्स,च्च ध्वनि बन्छ'],
                ['6. Palatalization (구개음화)', 'ㄷ,ㅌ + 이/히', '같이 / 해돋이', '[가치] / [해도지]', 'ㄷ→[지], ㅌ→[치] उच्चारण हुन्छ'],
                ['7. Liquidization (유음화)', 'ㄴ + ㄹ  or  ㄹ + ㄴ', '신라 / 연락', '[실라] / [열락]', 'दोनै ध्वनि ल-ल [ㄹ-ㄹ] बन्छ'],
                ['8. Double Batchim (겹받침)', 'Consonant / Vowel check', '앉다 / 읽다 / 읽어요', '[안따] / [익따] / [일거요]', 'नियम अनुसार एउटा ध्वनि मात्र बोल्ने'],
                ['9. N-Addition (ㄴ첨가)', 'Consonant + 이,야,여,요,유', '맨입 / 솜이불', '[맨닙] / [솜니불]', 'बीचमा "ㄴ" (न) ध्वनि थपिन्छ'],
                ['10. ㄹ Nasalization (ㄹ비음화)', 'ㅁ,ㅇ,ㄱ,ㅂ + ㄹ', '종로 / 음료수 / 백로', '[종노] / [음뇨수] / [뱅노]', 'ㄹ ध्वनि "ㄴ" मा परिणत हुन्छ'],
              ],
            },
          },
          {
            ...
            type: 'QUIZ',
            quizQuestion: {
              question: 'How is the word "한국어" (Korean language) pronounced according to the Sound Linking Rule (연음 법칙)?',
              options: ['[한국어]', '[한구거]', '[한국어]', '[하구거]'],
              correctIndex: 1,
              explanation: 'According to the Sound Linking Rule, the final consonant ㄱ in 국 moves to the silent position of ㅇ in 어, making the spoken sound [한구거] (Han-gu-geo).',
            },
          },
          {
            id: 'm3l6_q2',
            type: 'QUIZ',
            quizQuestion: {
              question: 'How is the polite sentence ending "입니다" pronounced in spoken Korean according to Nasalization (비음화)?',
              options: ['[입니다]', '[임니다]', '[입마다]', '[이니다]'],
              correctIndex: 1,
              explanation: 'According to Nasalization Rule C (ㅂ + ㄴ → [ㅁ]), the Batchim ㅂ in 입 softens to [ㅁ] before initial sound ㄴ in 니, resulting in [임니다] (im-ni-da).',
            },
          },
          {
            id: 'm3l6_q3',
            type: 'QUIZ',
            quizQuestion: {
              question: 'How is "같이" (together) pronounced according to the Palatalization Rule (구개음화)?',
              options: ['[가티]', '[가치]', '[갓이]', '[가지]'],
              correctIndex: 1,
              explanation: 'According to Palatalization, when Batchim ㅌ is followed by vowel "ㅣ", the ㅌ shifts to the palate and sounds like [ㅊ], so "같이" is pronounced as [가치] (ga-chi / सँगै).',
            },
          },
          {
            id: 'm3l6_q4',
            type: 'QUIZ',
            quizQuestion: {
              question: 'How is the word "연락" (contact/communication) pronounced under the Liquidization Rule (유음화)?',
              options: ['[연낙]', '[연락]', '[열락]', '[열낙]'],
              correctIndex: 2,
              explanation: 'Under the Liquidization Rule (ㄴ + ㄹ → [ㄹ-ㄹ]), the ㄴ assimilates into ㄹ, making "연락" sound like [열락] (yeol-rak / सम्पर्क).',
            },
          },
        ],
      },
