      ...
      <main className="pt-14 pb-20 md:pt-0 md:pb-0">
        ...
        <section className="px-4 pt-8 pb-6 text-center">
          <p className="text-sm text-gray-500 mb-2 font-medium tracking-wide">
            your gateway to japan and korea
          </p>
          ...
          <div className="flex justify-center gap-3 mt-5">
            <Link
              href="/japan"
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-pink-100 text-pink-700 border border-pink-200 text-sm font-medium hover:bg-pink-200 transition-colors"
            >
              🇯🇵 japan
            </Link>
            <Link
              href="/korea"
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 border border-blue-200 text-sm font-medium hover:bg-blue-200 transition-colors"
            >
              🇰🇷 korea
            </Link>
          </div>
