          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-7 space-y-3 text-left">
              ...
              <div className="flex items-center gap-3 pt-1">
                <Link
                  href="/learn"
                  className="px-6 py-2.5 rounded-2xl bg-red-600 hover:bg-red-500 text-white text-sm font-extrabold shadow-sm transition-all cursor-pointer"
                >
                  Get Started
                </Link>
                <Link
                  href="/consultancy"
                  className="px-6 py-2.5 rounded-2xl bg-white border border-gray-200 hover:bg-gray-50 text-gray-800 text-sm font-bold shadow-sm transition-all cursor-pointer"
                >
                  Explore Services
                </Link>
              </div>
            ...
            {/* Right Landmark Illustration — Blended into background (no card frame) */}
            <div className="md:col-span-5 flex justify-center items-center">
              <div className="relative w-full max-w-sm">
                <div className="absolute inset-0 bg-gradient-to-tr from-rose-100/40 via-indigo-100/30 to-blue-100/40 rounded-full blur-3xl -z-10" />
                <img
